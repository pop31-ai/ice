...
- **[📅 Лента эпох](epochs.html)** — 21 месяц жизни лагеря, выпуски по датам;
- **[✨ Полиарт-φ](polyart.html)** — 120 обложек в фирменном стиле: полиномиальные слои, золотое сечение, кристаллы;
- **[🖼 Ситуация — иллюстрация](situations.html)** — 72 полиарт-зарисовки: каждое событие лагеря отвечает картиной.
...
python gen_epochs.py         # epochs.html — лента эпох (21 месяц)
python gen_polyart.py        # polyart.html — полиарт-галерея обложек
python gen_situations.py     # situations/ + situations.html — 72 зарисовки событий
```