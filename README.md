...
(и проектируемый модуль «Айс-генератор айсбергов» — силуэты из шума, экспорт JSON);
...
| 🎓 | **Проектная работа** — журнал о репозитории: структура git, подходы, «по науке»; план модуля «Айс-генератор айсбергов» (1 выпуск) | 30 | [PDF](journals_pdf/proektnaya-rabota.pdf) |
